<?php
	...
	class manipulacaoDeDados extends conexaoMySQL
	{
		...
		public function setImob($imb)
		{
			$this->codimobiliaria = $imb;
		}
		...
		public function selecionar($tabela, $codimobiliaria){
			$sql 	= "SELECT * FROM $tabela WHERE $codimobiliaria";
			$qry 	= self::executarSQL($sql);
			$linha 	= self::listar($qry);
			return $linha;
		}
